...
class Pinecone < Formula
  ...
  disable! date: "2026-03-30", because: "has migrated to a cask. Reinstall with: brew uninstall pinecone-io/tap/pinecone && brew install --cask pinecone-io/tap/pinecone"
end
